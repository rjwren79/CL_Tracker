...
If Me.CmbMonth.Value <> vbNullString And Me.CmbYear.Value <> vbNullString Then
    Call Show_Dates
...
'================ Add Years =======================
  ...
  Year_Start = VBA.Year(VBA.Date) - 60
  Year_End = VBA.Year(VBA.Date) + 10
...
Private Sub Show_Dates()
    ...
    For i = 1 To 41
        ...
        If btn1.Caption <> vbNullString Then
...
For i = 1 To 42
    ...
    With btn
        ...
        If .Caption = vbNullString Then  'Disbale for blanks
            .Enabled = False
